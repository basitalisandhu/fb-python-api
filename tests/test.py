...
class ApiTest(unittest.TestCase):
    ...
    def test_get_place_id(self, mock_get):
        place_details = [
        ...
        mock_get.return_value.json.return_value = place_details
        place = "redline coffee company"
    ...
    def test_get_place_phone_number(self, mock_get_place_phone_number):
        ...
        mock_get_place_phone_number.return_value.status_code = 200
